    ...
    {
      {
        trunk =
        {
          filename = "__Bio_Industries__/graphics/entities/biofarm/tree/trunk.png",
          width = 38,
          height = 71,
          frame_count = 4,
          shift = {0, -0.55}
        ...
        leaves =
        {
          filename = "__Bio_Industries__/graphics/entities/biofarm/tree/leaves.png",
          width = 37,
          height = 60,
          frame_count = 3,
          shift = {0, -1.00}
    ...
    {
      {
        ...
        leaves =
        {
          filename = "__Bio_Industries__/graphics/entities/biofarm/tree/leaves_old.png",
          width = 45,
          height = 50,
          frame_count = 3,
          shift = {0, -1.00}
