...
if BI.Settings.BI_Recipe_Tweaks then
	...
	--- Rail
	if data.raw.item["stone-crushed"] and BI.Settings.Wood_Products then
...
if data.raw.item["alien-artifact"] then
	...
	thxbob.lib.add_new_recipe_item("bi-adv-fertiliser", {type="item", name="alien-artifact", amount=5})

	--- Bio Fuel will use Alien Artifact	
	--thxbob.lib.add_new_recipe_item("bi-Bio_Fuel", {type="item", name="alien-artifact", amount=1})
	...
	thxbob.lib.add_new_recipe_item("Bio_Cannon_Bio_Ammo", {type="item", name="alien-artifact", amount=5})
	
else

	thxbob.lib.add_new_recipe_item("bi-adv-fertiliser", {type="fluid", name="sulfuric-acid", amount=50})
	--thxbob.lib.add_new_recipe_item("bi-Bio_Fuel", {type="fluid", name="sulfuric-acid", amount=10})
